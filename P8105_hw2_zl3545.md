...
```
    ...
    ## # A tibble: 1,170 × 10
    ##    baker_name  series episode baker_age baker_occupation hometown signature_bake
    ##    <chr>        <dbl>   <dbl>     <dbl> <chr>            <chr>    <chr>         
    ##  1 Ali Imdad        4       1        25 Charity worker   Saltley… Rose and Pist…
    ##  2 Ali Imdad        4       2        25 Charity worker   Saltley… Italian Griss…
    ##  3 Ali Imdad        4       3        25 Charity worker   Saltley… Coconut, Rasp…
    ##  4 Ali Imdad        4       4        25 Charity worker   Saltley… Apple and Gin…
    ##  5 Alice Fevr…     10      NA        28 Geography teach… Essex    <NA>          
    ##  6 Alvin Maga…      6       1        37 Nurse            Brackne… Orange Vanill…
    ##  7 Alvin Maga…      6       2        37 Nurse            Brackne… Jackfruit, Pi…
    ##  8 Alvin Maga…      6       3        37 Nurse            Brackne… Prosciutto, M…
    ##  9 Alvin Maga…      6       4        37 Nurse            Brackne… Blackberry Cr…
    ## 10 Alvin Maga…      6       5        37 Nurse            Brackne… Pineapple Ups…
    ## # ℹ 1,160 more rows
